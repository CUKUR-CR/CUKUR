...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-motel/Files_motel/main/File_Bot/commands.lua") 
...
function DevoMr(msg) 
local hash = database:sismember(bot_id.."Dev:oMr:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevoMr(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevoMr(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevoMr(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevoMr(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevoMr(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevoMr(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1340441424) then  
var = true  
elseif tonumber(user_id) == tonumber(7) then
var = true  
elseif tonumber(user_id) == tonumber(7) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:oMr:2", user_id) then
var = true  
...
local UserName = (data.username_ or "@cc_vv2")
...
local motel_Msg = ''  
if msgs < 100 then 
motel_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
motel_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
motel_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
motel_Msg = 'متفاعل' 
elseif msgs < 1200 then 
motel_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
motel_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
motel_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
motel_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
motel_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
motel_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
motel_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
motel_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
motel_Msg = 'رب التفاعل'  
end 
return motel_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘊𝘜𝘒𝘜𝘙.")  
...
function plugin_motel(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.motel and msg then
pre_msg = plugin.motel(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcemotel(msg,data) -- بداية العمل
if msg then
...
if DevoMr(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,motel_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⋄' and DevoMr(msg) then  
...
if text == 'تعطيل التواصل ⋄' and DevoMr(msg) then  
...
if text == 'تعطيل البوت الخدمي ⋄' and DevoMr(msg) then  
...
if text == 'ضع كليشه ستارت ⋄' and DevoMr(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'⋄︙ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⋄' and DevoMr(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'⋄︙تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ⋄' and DevoMr(msg) then 
...
if text == 'تحديث السورس ⋄' and DevoMr(msg) then 
os.execute('rm -rf motel.lua')
os.execute('wget https://raw.githubusercontent.com/motel942/motel/main/motel.lua')
send(msg.chat_id_, msg.id_,'⋄︙تم تحديث السورس \n⋄︙لديك اخر اصدار لسورس حفره\n⋄︙الاصدار ~ { v 1.6 }')
dofile('motel.lua')  
end
if text == 'الاصدار ⋄' and DevoMr(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⋄︙اصدار سورس حفره \n⋄︙الاصدار ~{ v 1.6 }')
end
if text == "ضع اسم للبوت ⋄" and DevoMr(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⋄︙ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⋄' and DevoMr(msg) then 
...
if text == 'المشتركين ⋄' and DevoMr(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⋄︙المشتركين~{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⋄' and DevoMr(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⋄︙الكروبات~{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⋄") and DevoMr(msg) then
...
if text == ("الثانويين ⋄") and DevoMr(msg) then
local list = database:smembers(bot_id..'Dev:oMr:2')
t = "\n⋄︙قائمة الثانويين \n⊶─────≺⋆≻─────⊷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "🐉 حصريات و تحديثات حفره 🐉" and DevoMr(msg) then  
local updatech =[[
...
{{text = '⋄︙SoUrCe motel.', url="t.me/cc_vv2"}},
}
...
-----------
if text == ("قائمه العام ⋄") and DevoMr(msg) then
...
if text == ("قائمه الكتم العام ⋄") and DevoMr(msg) then
...
if text=="اذاعه خاص ⋄" and msg.reply_to_message_id_ == 0 and DevoMr(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋄︙ارسل الان اذاعتك؟ \n⋄︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⋄" and msg.reply_to_message_id_ == 0 and DevoMr(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋄︙ارسل الان اذاعتك؟ \n⋄︙للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⋄" and msg.reply_to_message_id_ == 0 and DevoMr(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋄︙ارسل الان اذاعتك؟ \n⋄︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⋄" and msg.reply_to_message_id_ == 0  and DevoMr(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋄︙ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⋄" and msg.reply_to_message_id_ == 0  and DevoMr(msg) then 
...
if text == "تنظيف الكروبات ⋄" and DevoMr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⋄︙ عدد الكروبات الان ~ { '..#group..' }'..motelk..''..motel..'\n⋄︙ الان عدد الكروبات الحقيقي ~ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevoMr(msg) then
...
usertext = '\n⋄︙العضو ↫ ['..result.title_..'](t.me/'..(username or 'cc_vv2')..')'
status  = '\n⋄︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevoMr(msg) then
...
usertext = '\n⋄︙العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'cc_vv2')..')'
status  = '\n⋄︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevoMr(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevoMr(msg) then
...
local motel1_Msg = database:get(bot_id.."motel1:Add:Filter:Rp2"..text..msg.chat_id_)   
if motel1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋄︙العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'cc_vv2')..') \n⋄︙'..motel1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if motel_Msg and not Special(msg) then  
local motel_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if motel_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⋄︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⋄︙["..motel_Msg.."] \n")
else
send(msg.chat_id_,0,"⋄︙العضو : {["..data.first_name_.."](T.ME/cc_vv2)}\n⋄︙["..motel_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⋄︙عذرا يا » {["..data.first_name_.."](t.me/cc_vv2)}\n⋄︙الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard.inline_keyboard = {
{
{text = '⋄ معرفة المزيد ؟',url="https://t.me/cc_vv2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevoMr(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevoMr(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevoMr(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⋄" and DevoMr(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "⋄︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⋄$") and DevoMr(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⋄" and DevoMr(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⋄" and DevoMr(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⋄︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⋄" and DevoMr(msg) then  
...
database:sadd(bot_id.."motel:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."motel:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_MRoMr = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRoMr then 
names_MRoMr = database:smembers(bot_id.."motel:blocname"..msg.chat_id_) or ""
if names_MRoMr and names_MRoMr[1] then 
for i=1,#names_MRoMr do 
if name_MRoMr:match("(.*)("..names_MRoMr[i]..")(.*)") then 
...
database:set(bot_id.."motel:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."motel:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."motel:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."motel:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."motel:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function oMr_mroMr_new(mroMr1,mroMr2)
if mroMr2 and mroMr2.first_name_ then 
if mroMr2.first_name_:match("(.*)"..database:get(bot_id.."motel:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."motel:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mroMr_nnn = database:get(bot_id.."motel:nump"..msg.chat_id_) or 5
local mroMr_nnn2 = database:get(bot_id.."motel:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mroMr_nnn2) == tonumber(mroMr_nnn) or tonumber(mroMr_nnn2) > tonumber(mroMr_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."motel:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⋄︙عزيزي >>["..mroMr2.username_.."](https://t.me/"..(mroMr2.username_ or "cc_vv2")..")\n⋄︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."motel:teh"..msg.chat_id_).."} بجانب اسمك\n⋄︙عدد المحاولات المتبقيه {"..(tonumber(mroMr_nnn) - tonumber(mroMr_nnn2)).."}")
end
end
end
end
bnnaGet(id, oMr_mroMr_new)
end
end
...
local motelChengName = database:get(bot_id.."motel:Cheng:Name"..data.id_)
if not data.first_name_ then 
if motelChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..motelChengName..']')
database:del(bot_id.."motel:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if motelChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."motel:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local motelChengUserName = database:get(bot_id.."motel:Cheng:UserName"..data.id_)
if not data.username_ then 
if motelChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..motelChengUserName..']')
database:del(bot_id.."motel:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if motelChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."motel:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local motelChengPhoto = database:get(bot_id.."motel:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if motelChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."motel:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if motelChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."motel:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = [[
┌─────── 𝐌𝐑 ───────┐
⋄︙*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 𝘊𝘜𝘒𝘜𝘙*
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘊𝘜𝘒𝘜𝘙 𝘵𝘦𝘢𝘮](http://t.me/Gukur_v)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘪𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝘊𝘜𝘒𝘜𝘙](https://t.me/cc_vv2)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳](http://t.me/Q_8OO)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘵𝘸𝘴 𝘵𝘦𝘢𝘮](http://t.me/x_exbot)
└─────── 𝐌𝐑 ───────┘
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'*⋄︙بواسطه ↫*['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'cc_vv2')..') \n*⋄︙تم قفـل ↫ الدردشه*\n*⋄︙الايدي ↫* `'..msg.sender_user_id_..'`')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevoMr(msg) then    
dofile('motel.lua')  
send(msg.chat_id_, msg.id_, '*⋄︙تم تحديث جميع الملفات البوت .*') 
end 
if text == ("مسح قائمه العام") and DevoMr(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevoMr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if tonumber(result.sender_user_id_) == tonumber(1340441424) then  
...
function(arg,data) 
usertext = '\n*⋄︙المستخدم ↫* ['..data.first_name_..'](t.me/'..(data.username_ or 'cc_vv2')..')'
...
if text and text:match("^حظر عام @(.*)$")  and DevoMr(msg) then
...
if result.id_ == tonumber(1340441424) then
send(msg.chat_id_, msg.id_, "*⋄︙سنفر لا يمكنك حظر مطور السورس* \n")
return false 
end
...
usertext = '\n*⋄︙المستخدم ↫* ['..result.title_..'](t.me/'..(username or 'cc_vv2')..')'
status  = '\n*⋄︙تم حظره عام من المجموعات*'
texts = usertext..status
...
if text and text:match("^حظر عام (%d+)$") and DevoMr(msg) then
...
if userid == tonumber(1340441424) then
send(msg.chat_id_, msg.id_, "*⋄︙سنفر لا يمكنك حظر مطور السورس* \n")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevoMr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevoMr(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevoMr(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevoMr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevoMr(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevoMr(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevoMr(msg) then
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,oMr)
x = 0
tags = 0
local list = oMr.members_
for k, v in pairs(list) do
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevoMr(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevoMr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:oMr'..msg.chat_id_) then
Text = '*⋄︙تم تفعيل تحويل الصيغ*'
database:del(bot_id..'DRAGOON:change:oMr'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:oMr'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:oMr'..msg.chat_id_,true)  
Text = '\n*⋄︙تم تعطيل امر تحويل*'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:oMr'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-motel")
...
function Function_motel(extra, result, success)
database:sadd(bot_id.."Dev:oMr:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*⋄︙تم ترقيته مطور ثانوي في البوت*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_motel, nil)
return false 
end
...
function Function_motel(extra, result, success)
database:srem(bot_id.."Dev:oMr:2", result.sender_user_id_)
...
function Function_motel(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:oMr:2", result.id_)
...
database:srem(bot_id.."Dev:oMr:2", userid)
...
if text == ("رفع منظف") and msg.reply_to_message_id_ and CoSu(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع منظف @(.*)$") and CoSu(msg) then
...
if text and text:match("^رفع منظف (%d+)$") and CoSu(msg) then
...
if text == ("تنزيل منظف") and msg.reply_to_message_id_ and CoSu(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل منظف @(.*)$") and CoSu(msg) then
...
if text and text:match("^تنزيل منظف (%d+)$") and CoSu(msg) then
...
------------------------------------------------------------------------
------------------------------------------------------------------------
if text == 'مسح المميزين' and Manager(msg) then
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not BasicConstructor(msg) then
send(msg.chat_id_, msg.id_,'*⋄︙تم تعطيل الرفع من قبل المنشئين من قبل المنشئين*') 
return false
end
function start_function(extra, result, success)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋄︙العضــو ~ ['..data.first_name_..'](t.me/'..(data.username_ or 'cc_vv2')..')'
...
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n*⋄︙عذرا لا يمكنك تقيد ↫* '..Rutba(result.sender_user_id_,msg.chat_id_)..' ')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n*⋄︙عذرا لا يمكنك تقيد ↫* '..Rutba(result.id_,msg.chat_id_)..' ')
return false 
end      
...
TextEnd[3] = TextEnd[3]:gsub("يوم","ايام") 
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n*⋄︙عذرا لا يمكنك تقيد ↫* '..Rutba(userid,msg.chat_id_)..' ')
else
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋄︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'cc_vv2')..')'
...
send(msg.chat_id_, msg.id_,"*⋄︙تم تفعيل رابط المجموعه*") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"*⋄︙تم تعطيل رابط المجموعه*") 
return false end
end
...
send(msg.chat_id_, msg.id_,"*⋄︙عذرآ الرابط معطل اكتب تفعيل الرابط*") 
return false  
end
...
database:set(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"*⋄︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."motel1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."motel1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"*⋄︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."motel1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."motel1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."motel1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"*⋄︙ارسل الكلمه الان*")  
database:set(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."motel1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."motel1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."motel1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."motel1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."motel1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."motel1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n*⋄︙قائمة المنع* \n*⊶─────≺⋆≻─────⊷*\n"
for k,v in pairs(list) do  
local motel_Msg = database:get(bot_id.."motel1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ~ {"..motel_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevoMr(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'*⋄︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevoMr(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*⋄︙بواسطه ↫* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'cc_vv2')..') \n*⋄︙تـم تفعيـل الحـمايه* ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋄︙العضو ~ ['..result.title_..'](t.me/'..(text1[3] or 'cc_vv2')..')'..'\n⋄︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevoMr(msg) then  
...
if text == 'تعطيل الاذاعه' and DevoMr(msg) then  
...
if text == "تنظيف التعديل" and CoSu(msg) then
Msgs = {[0]=msg.id_}
local Message = msg.id_
for i=1,100 do
Message = Message - 1048576
...
send(msg.chat_id_, msg.id_,'['..motel_Msg[math.random(#motel_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevoMr(msg) then 
...
send(msg.chat_id_, msg.id_,"*⋄︙سرسح لا تستطيع تنزيل المطور الاساسي*")
return false 
end
...
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:oMr:2',msg.sender_user_id_) then
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevoMr(msg) then 
...
if text == "اضف رد للكل" and DevoMr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and DevoMr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n*⋄︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:motel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:motel:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:motel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"*⋄︙تم حذف الرد من ردود المتعدده*")
database:del(bot_id..'botss:motel:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:motel:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:motel:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:motel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:motel:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:motel:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:motel:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:motel:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:motel:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:motel:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘊𝘜𝘒𝘜𝘙.',url="t.me/cc_vv2"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text == "تفعيل تاك المشرفين" and Constructor(msg) then 
database:set(bot_id.."cc_vv2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"*⋄︙تم تفعيل تاك المشرفين*")
end
if text and text == "تعطيل تاك المشرفين" and Constructor(msg) then 
database:del(bot_id.."@cc_vv2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."cc_vv2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس حفره يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:motel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"*⋄︙ارسل الان الكلمه لحذفها*")
end
if text then  
local test = database:get(bot_id.."botss:motel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:motel:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:motel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:motel:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:motel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:motel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:motel:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:motel:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:motel:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:motel:Add:Rd:Sudo:Text2"..text)   
...
if text == 'تفعيل المغادره' and DevoMr(msg) then   
...
if text == 'تعطيل المغادره' and DevoMr(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'cc_vv2')..')'
local iduser = result.sender_user_id_
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,oMr,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (oMr.total_count_ or 0)
...
local rdphoto = oMra[math.random(#oMra)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, oMr.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n⋄︙ايديك ↫ '..msg.sender_user_id_..'\n⋄︙معرفك ↫ '..username..'\n⋄︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n⋄︙موقعك ↫ '..rtpa..'\n⋄︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n⋄︙رسائلك ↫ '..Msguser..'\n⋄︙السحكات ↫ '..edit..'\n⋄︙نقاطك ↫ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n⋄︙ايديك ↫ '..msg.sender_user_id_..'\n⋄︙معرفك ↫ '..username..'\n⋄︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n⋄︙موقعك ↫ '..rtpa..'\n⋄︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n⋄︙رسائلك ↫ '..Msguser..'\n⋄︙السحكات ↫ '..edit..'\n⋄︙نقاطك ↫ '..NUMPGAME..']\n')
else
...
-- vardump(data) 
moteldx(msg.chat_id_, msg.id_, '⋄︙ايدي المجموعة ~ ( '..msg.chat_id_..' )\n⋄︙عدد الادمنيه ~ ( *'..data.administrator_count_..' )*\n⋄︙عدد المحظورين ~ ( *'..data.kicked_count_..' )*\n⋄︙عدد الاعضاء ~ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
oMr = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,oMr)  
...
oMr = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,oMr)  
...
{
{text = '𝘊𝘜𝘒𝘜𝘙 𝘊𝘏𝘈𝘕𝘕𝘌𝘓', url="t.me/cc_vv2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
database:set(bot_id.."oMr:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'*⋄︙تم تفعيل الافلام*')
database:set(bot_id.."oMr:movie_bot"..msg.chat_id_,"open")
end
...
send(msg.chat_id_, msg.id_,"⚠️꒐ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'🎭꒐ للاسف لقد خسرت \n👊꒐ المحيبس بل ايد رقم { '..GETNUM..' }\n◀️꒐ حاول مره اخرى للعثور على المحيبس')
end
end
end

if text == 'محيبس' or text == 'بات' or text == 'البات' then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
◀️꒐ اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"نجيب بيبي صغير قبل لزواج 🦦💘 ","عيدمشيلڪ دودة اني ابني بڪدك دور علاقات عابرة 🦦🤸🏿‍♀","وقتنا هذا وقت فراش ڪبل مو سوالف ارتباط وڪڪ 🌚🌈" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يمعود لعالم وين وصلت وانت تصيح بوت شڪد تافه 🙂🤸‍♀","اي بوت قسم بالله تعبت منڪم تفففو 🙂💦" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {" نورڪ يا حلوو 💘🌈","فدوةة من بعدڪ 🤸🏿‍♀💕","اعرف بنفسي ضوة لتلح 🦦💘","وهل يخفى القمر اكيد النور ڪلة انا 💕🌝","اغوح فدوةة انت نوغ كلةة عمغي 🤸‍♀💘 "} 
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == "فرووخ" or text == "فرخ" or text == "فرووخخ" or text == "فروووخ" or text == "فففروخ" or text =="فففرووخ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"وينة خلي احصرة 😳","وينهم خلي نحصرهم بسرعة 🏃‍♂","ي مثلڪ ابو الهياڪل 🦦🏳‍🌈","هع نسيت منو ڪسر عينڪ 🙇🔞","قسم بالله وڪت الجان فرخ هسة يشمر 🤦‍♂🧬 "} 
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
motel = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(motel)
...
--------------------------------------------------------------------------------------------------------------
Sourcemotel(data.message_,data)
plugin_motel(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local motelAbot = database:get(bot_id.."motel1:Add:Filter:Rp2"..text..result.chat_id_)   
if motelAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⋄︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⋄︙["..motelAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local motel1_Msg = database:get(bot_id.."motel1:Add:Filter:Rp2"..text..result.chat_id_)   
if motel1_Msg then    
send(msg.chat_id_, msg.id_,"⋄︙"..motel1_Msg)
...
end -- end new msg dev.mr oMr 
end -- end callback dev.mr oMr
